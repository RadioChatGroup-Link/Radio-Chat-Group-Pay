...
<div class="card card-primary">	
			<div class="card-header"><h3 class="panel-title">站点Logo配置</h3></div>
<div class="card-body">
  <form action="./shepay_logo.php?mod=site_n" method="post" class="form-horizontal" role="form">
	<div class="form-group">
	  <label class="col-sm-4 control-label">Logo图片地址:</label>
	  <div class="col-sm-auto"><input type="text" name="logo_url" value="<?php echo $conf['logo_url']?>" class="form-control" required/><small>* 显示调用数据库表"['logo_url']"。</small><br>现在的图片：<br><img src="<?php echo $conf['logo_url']?>" style="max-width:100%"></div>
	</div>
	<div class="form-group">
