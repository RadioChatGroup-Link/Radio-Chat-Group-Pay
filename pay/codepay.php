...
//            "https" => 1,//启用HTTPS
    ...
    "return_url" => 'http://'.$_SERVER['HTTP_HOST'].'/pay/codepay_return.php',//付款后附带加密参数跳转到该页面
    "notify_url" => 'http://'.$conf['local_domain'].'/pay/codepay_notify.php',//付款后通知该页面处理业务
...
$user_data = array("return_url" => 'http://'.$_SERVER['HTTP_HOST'].'/pay/codepay_return.php',
...
<head>
    ...
    <link href="//shepay.ayunx.com/assets/codepay/css/wechat_pay.css" rel="stylesheet" media="screen">
            ...
            <div data-role="qrPayImg" class="qrcode-img-area">
                ...
                <div style="position: relative;display: inline-block;">
                    ...
                    <img onclick="$('#use').hide()" id="use"
                         src="//shepay.ayunx.com/assets/codepay/img/use_<?php echo $type ?>.png"
...
<div class="copyRight">
    <p>Copyright <a href="/" target="_blank">都潮汇系统</a></p>
</div>

<!--注意下面加载顺序 顺序错乱会影响业务-->
<script src="//shepay.ayunx.com/assets/codepay/js/jquery-1.10.2.min.js"></script>
<!--[if lt IE 8]>
<script src="//shepay.ayunx.com/assets/codepay/js/json3.min.js"></script><![endif]-->
<script>
    var user_data =<?php echo json_encode($user_data);?>
</script>
<script src="//shepay.ayunx.com/assets/codepay/js/notify.js"></script>
<script src="//shepay.ayunx.com/assets/codepay/js/codepay_util.js"></script>
