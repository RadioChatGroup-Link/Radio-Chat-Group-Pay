...
<form action="shepay_order.php" method="GET" class="form-inline"><input type="hidden" name="my" value="search">
...
if ($page>1)
{
echo '<li><a href="shepay_order.php?page='.$first.$link.'">首页</a></li>';
echo '<li><a href="shepay_order.php?page='.$prev.$link.'">&laquo;</a></li>';
} else {
echo '<li class="disabled"><a>首页</a></li>';
echo '<li class="disabled"><a>&laquo;</a></li>';
}
for ($i=1;$i<$page;$i++)
echo '<li><a href="shepay_order.php?page='.$i.$link.'">'.$i .'</a></li>';
...
if ($page<$pages)
{
echo '<li><a href="shepay_order.php?page='.$next.$link.'">&raquo;</a></li>';
echo '<li><a href="shepay_order.php?page='.$last.$link.'">尾页</a></li>';
} else {
