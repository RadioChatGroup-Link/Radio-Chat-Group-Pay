...
function send_mail($to, $sub, $msg) {
	...
	if($mail_api) {
		...
		include_once ROOT.'shepay/smtp.class.php';
		$From = $conf['mail_name'];
		$Host = $conf['mail_smtp'];
		$Port = $conf['mail_port'];
		$SMTPAuth = 1;
...
function update_version(){
	...
	$query=@file_get_contents("http://auth.ooeecc.cn/api/check.php?url=".$_SERVER['HTTP_HOST']."&authcode=".$authcode."&ver=".$ver."&dbver=".$dbver);
...
if(md5_file(ROOT.'shepay/common.php')!=='6f3b9a9fec9cf711a1484ad10fb2b205'){
     echo '<h3><html> <head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
