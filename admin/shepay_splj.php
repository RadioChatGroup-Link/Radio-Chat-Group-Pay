...
<div class="card-header"><h3 class="panel-title">商品拦截配置</h3></div>
<div class="card-body">
<form action="./shepay_splj.php?mod=site_n" method="post" class="form-horizontal" role="form">
<div class="form-group">
<label class="col-sm-4 control-label">商品拦截关键词:</label>
<div class="col-sm-auto">
<textarea name="goods_lj" rows="5" class="form-control"><?php echo $conf['goods_lj']; ?></textarea>
<small>* 拦截多个商品请用、分隔 如：刷单、小视频、直播、钓鱼</small>
</div><br>
	<div class="form-group">
	  <label class="col-sm-4 control-label">商品拦截后提示:</label>
	  <div class="col-sm-auto">
   <textarea name="goods_ljtis" rows="5" class="form-control"><?php echo $conf['goods_ljtis']; ?></textarea>    
  </div>
	</div><br/>
	<div class="form-group">
