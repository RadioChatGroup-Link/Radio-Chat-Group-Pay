...
$data = get_curl('此处填写所对接易支付的财付通接口地址（开头带http://或https://结尾带/）/api.php?act=orders&limit=50&pid=此处填写所对接易支付的财付通接口商户ID&key=此处填写所对接易支付的财付通接口商户密钥');
