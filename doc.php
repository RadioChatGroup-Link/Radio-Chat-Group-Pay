...
<head>
<meta charset="utf-8"/>
<title><?php echo $conf['web_name']?> - 一站式免签约支付方案</title>
<meta name="keywords" content="<?php echo $conf['web_name']?>,支付宝免签约即时到账,财付通免签约,微信免签约支付,QQ钱包免签约,免签约支付"/>
<meta name="description" content="<?php echo $conf['web_name']?>免签约支付产品，可以助你一站式解决网站签约各种支付接口的难题，现拥有支付宝、财付通、QQ钱包、微信支付等免签约支付功能，并有开发文档与SDK，可快速集成到你的网站"/>
...
<a href="/"><span class="logo" style="background:url('<?php echo $conf['logo_url']?>') no-repeat;height: 52px"></span></a>
</div>
...
<li class="dropdown"><a class="dropdown-toggle"data-toggle="dropdown" href="http://pay.m6e6.cn/user/">用户中心<b class="caret"></b></a>
<ul  class="dropdown-menu"style="width: 100%;">
<li><a style="line-height:30px;" href="http://pay.m6e6.cn/user/">登陆</a></li>
<li><a style="line-height:30px;" href="http://pay.m6e6.cn/user/reg.php">注册</a></li>
</ul>
</li>
</ul>
</div>
...
<p>共有两种接口模式：</p>
<p>（一）普通支付商户<br/>可以获得一个支付商户，完全免费申请。公测期间请联系人工申请QQ<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $conf['web_qq']?>&amp;site=qq&amp;menu=yes"><?php echo $conf['web_qq']?></a>，申请之后会将商户ID和商户KEY给你！</p>
<p>（二）合作支付商户<br/>获得一个合作者身份TOKEN，可以集成到你开发的程序里面，通过接口无限申请普通支付商户，并且每个普通支付商户单独结算，相对独立。公测期间请联系人工申请QQ<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $conf['web_qq']?>&amp;site=qq&amp;menu=yes"><?php echo $conf['web_qq']?></a>，申请之后会将合作者身份TOKEN给你！</p>
<h2 id="toc2">协议规则</h2>
<p>传输方式：HTTP</p>
<p>数据格式：JSON</p>
<p>签名算法：MD5</p>
...
<p>URL地址：https://<?php echo $conf['local_domain']?>/api.php?act=apply&amp;token={合作者身份TOKEN}&amp;url={商户域名}</p>
<p>请求参数说明：</p>
...
<p>URL地址：https://<?php echo $conf['local_domain']?>/api.php?act=query&amp;pid={商户ID}&amp;key={商户密钥}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<table class="table table-bordered table-hover">
  ...
  <tr><td>结算账号</td><td>account</td><td>String</td><td>pay@m6e6.cn</td><td>结算的支付宝账号</td></tr>
...
<p>URL地址：https://<?php echo $conf['local_domain']?>/api.php?act=change&amp;pid={商户ID}&amp;key={商户密钥}&amp;account={结算账号}&amp;username={结算姓名}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
  ...
  <tr><td>商户ID</td><td>pid</td><td>是</td><td>Int</td><td>1001</td><td></td></tr>
  <tr><td>商户密钥</td><td>key</td><td>是</td><td>String</td><td>89unJUB8HZ54Hj7x4nUj56HN4nUzUJ8i</td><td></td></tr>
  <tr><td>结算账号</td><td>account</td><td>是</td><td>String</td><td>pay@m6e6.cn</td><td>结算的支付宝账号</td></tr>
...
<p>URL地址：https://<?php echo $conf['local_domain']?>/api.php?act=settle&amp;pid={商户ID}&amp;key={商户密钥}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<p>URL地址：https://<?php echo $conf['local_domain']?>/api.php?act=order&amp;pid={商户ID}&amp;key={商户密钥}&amp;out_trade_no={商户订单号}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<table class="table table-bordered table-hover">
  ...
  <tr><td>易支付订单号</td><td>trade_no</td><td>String</td><td>2016080622555342651</td><td>小明易支付订单号</td></tr>
...
<p>URL地址：https://<?php echo $conf['local_domain']?>/api.php?act=orders&amp;pid={商户ID}&amp;key={商户密钥}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<p>URL地址：https://<?php echo $conf['local_domain']?>/submit.php?pid={商户ID}&amp;type={支付方式}&amp;out_trade_no={商户订单号}&amp;notify_url={服务器异步通知地址}&amp;return_url={页面跳转通知地址}&amp;name={商品名称}&amp;money={金额}&amp;sitename={网站名称}&amp;sign={签名字符串}&amp;sign_type=MD5</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
  ...
  <tr><td>网站名称</td><td>sitename</td><td>否</td><td>String</td><td>小明云任务</td><td></td></tr>
...
<table class="table table-bordered table-hover">
  ...
  <tbody>
  <tr><td>商户ID</td><td>pid</td><td>是</td><td>Int</td><td>1001</td><td></td></tr>
  <tr><td>易支付订单号</td><td>trade_no</td><td>是</td><td>String</td><td>20160806151343349021</td><td>小明易支付订单号</td></tr>
...
<h2 id="sdk0">集成替换包下载</h2>
<blockquote>
<a href="./user/jcb.php" style="color:blue">点此前往下载</a><br/>
替换包：各源码支付接口替换包文件
</blockquote>
<br>
<hr/>
<h2 id="sdk0">SDK源码下载</h2>
<blockquote>
<a href="./SDK/SDK.zip" style="color:blue">SDK.zip</a><br/>
SDK类型：<?php echo $conf['web_name']?>
</blockquote>
          </section>
      </article>
    </div>
...
<ul class="porduct">
<h4>友情链接</h4>
<li><a href="http://www.dch888.cn" target="_blank">都潮汇</a></li>
</ul>
<ul class="price">
<h4>关于我们</h4>
<li><?php echo $conf['web_name']?>平台是<?php echo $conf['web_name']?>有限公司旗下的免签约支付产品</li>
</ul>
<ul class="about"style="width: 40%;padding-left: 22px;">
<h4>联系我们</h4>
<li><strong>客服QQ:</strong><a target="_blank"href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $conf['web_qq']?>&amp;site=qq&amp;menu=yes"><?php echo $conf['web_qq']?></a></li>
<li><strong>Email:</strong><a name="baidusnap4"></a><a href="mailto:<?php echo $conf['web_qq']?>@qq.com"><?php echo $conf['web_qq']?>@qq.com</a></li>
</ul>
</div>
</div>
<div class="xinxi">
<p>Copyright © 2016-<?=date('Y')?> Powered by <a href="/"><?php echo $conf['web_name']?></a></p>
</div>
<script type="text/javascript">
